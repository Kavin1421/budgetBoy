          ...
          members: {
            ...
            items: {
              ...
              properties: {
                ...
                planDataPerDay: { type: "string", enum: ["No data", "1GB", "1.5GB", "2GB", "2.5GB", "3GB"] },
                actualUsagePerDay: { type: "string", enum: ["No data", "0.5GB", "1GB", "1.5GB", "2GB+"] },
                ...
                networkConfidence: { type: "integer", minimum: 1, maximum: 5 },
                rechargeFrictionPreference: { type: "string", enum: ["low", "medium", "high"] },
                dataRolloverRiskWindow: { type: "string", enum: ["never", "1-3", "4-8", "often"] },
                hotspotNeeded: { type: "boolean" },
                callQualitySensitivity: { type: "string", enum: ["low", "medium", "high"] },
                billShockTolerance: { type: "string", enum: ["yes", "no"] },
              },
            },
          },
          subscriptions: {
            ...
            items: {
              type: "object",
              required: ["name", "cost", "billingCycle", "used"],
              properties: {
                name: { type: "string" },
                cost: { type: "number" },
